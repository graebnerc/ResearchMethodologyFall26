  ...
  pdf:
    include-in-header: 
      text: |
        ...
        \ohead{\pagemark} %
        \ifoot{}
        \cfoot{\href{https://researchmethodology-fall26.netlify.app/}{\normalfont\color{eufblue}{Theoretical and Empirical Research Methodology - Fall Semester 2026}}} % Fußzeile Mitte
        \ofoot{} 
...
on [visualization](/content/material/s_08_Visualization.qmd) that this function takes,
