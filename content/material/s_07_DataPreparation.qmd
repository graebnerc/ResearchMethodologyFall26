---
title: "🗓️ Session 7: Data preparation"
date: "2026-11-06"
...
## Data for the intermediate exercises

- [Data used in the video](DataWranglingVideo.zip)
- [Data for exercises](DataPrepExData.zip)
:::

<!--- Solutions to the intermediate exercises are made available here after the session.
::: {.callout-tip collapse="true"}
...
make a line graph.
<!--- A possible solution is made available here after the session.
